...
import com.tracktr.helper.model.DeviceUtil;
import com.tracktr.schedule.ScheduleManager;
import com.tracktr.storage.DatabaseModule;
import com.tracktr.storage.Storage;
import com.tracktr.web.WebModule;
...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0 && args[0].startsWith("--")) {
            WindowsService windowsService = new WindowsService("tracktr") {
                @Override
                public void run() {
                    Main.run(configFile);
                }
            ...
            switch (args[0]) {
                case "--install":
                    windowsService.install("tracktr", null, null, null, null, configFile);
                    return;
                case "--uninstall":
