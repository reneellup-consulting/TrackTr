...
public class AttributeResource extends ExtendedObjectResource<Attribute> {
    ...
    @POST
    public Response add(Attribute entity) throws StorageException, MessagingException {
        permissionsService.checkAdmin(getUserId());
    ...
    @Path("{id}")
    @PUT
    public Response update(Attribute entity) throws StorageException, MessagingException {
        permissionsService.checkAdmin(getUserId());
