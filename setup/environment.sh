...
git clone --recurse-submodules https://github.com/rlllup0084/tracktr.git
(cd tracktr/tracktr-web && git checkout master)
(cd tracktr && ./gradlew build)
...
(cd tracktr/tracktr-web && ./package.sh)
